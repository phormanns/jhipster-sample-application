...
import de.ostwall195.jhipster.sample.repository.PostRepository;
...
import static de.ostwall195.jhipster.sample.web.rest.TestUtil.createFormattingConversionService;
...
public class PostResourceIntTest {
    ...
    public void createPost() throws Exception {
        ...
        assertThat(testPost.getShortText()).isEqualTo(DEFAULT_SHORT_TEXT);
        assertThat(testPost.getFullText()).isEqualTo(DEFAULT_FULL_TEXT);
    }
    ...
    public void updatePost() throws Exception {
        ...
        assertThat(testPost.getShortText()).isEqualTo(UPDATED_SHORT_TEXT);
        assertThat(testPost.getFullText()).isEqualTo(UPDATED_FULL_TEXT);
    }
